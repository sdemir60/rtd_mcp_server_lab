...
const standardsDatabase: { [key: string]: StandardDocumentation } = {
  'property-tanimlama': {
    ...
    description: 'C# dilinde property tanımlama kuralları ve en iyi uygulamalar.',
    rules: [
      {
        id: 'prop-01',
        title: 'Property Setter Koşul Kontrolü',
        description: 'Property setter içinde mutlaka değer değişiklik kontrolü yapılmalıdır. Bu kontrol sonsuz döngüyü önler.',
        examples: {
...
public string Code
{
    ...
    set
    {
      ...
      },
      {
        ...
        description: 'Public property isimleri PascalCase, private field isimleri camelCase olmalıdır.',
        examples: {
...
ShowStatusMessage("Form kaydedildi", DialogTypes.Info);`
      ...
      },
      {
        ...
        description: 'Language resource\'ları için doğru namespace kullanılmalıdır.',
        examples: {
  ...
  'naming-conventions': {
    ...
    rules: [
      ...
      },
      {
        ...
        description: 'Method isimleri PascalCase olmalı ve fiil ile başlamalıdır.',
        examples: {
    ...
    rules: [
      {
        ...
        examples: {
          ...
          incorrect: '[common].[distribution_channels] // ❌ lowercase ve çoğul'
        },
        severity: 'error'
      },
      {
        ...
        description: 'SP isimleri işlem tipini belirten prefix ile başlamalıdır.',
        examples: {
    ...
    rules: [
      {
        ...
        examples: {
          ...
          incorrect: '[Route("api/Common/DistributionChannel")] // ❌ PascalCase ve tekil'
        },
        severity: 'warning'
      },
      {
...
export function getStandardsDocumentation(topic: string): StandardDocumentation | null {
